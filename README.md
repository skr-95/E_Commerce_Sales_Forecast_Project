...
**本项目为Data Science项目, 在NoteBook上进行Python分析和建模(按阶段划分成四个NoteBook), 图表文报告总长10000字，总代码量近1500行，可视化近10余种图.**
...
* 利用该模型针对性提升指数低的用户, 如提升30%的转化率, 销售额将提高118626.67英镑, 即13.04%(具体如下图); 同时, 也可以从普遍促销转为针对性促销, 从而节省促销成本243627.1英镑, 即减少69.28%.
